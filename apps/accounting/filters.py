...
class AccountFilter(django_filters.FilterSet):
    book__user = django_filters.CharFilter(
        method="filter_by_all_name_fields",
        label="User (by Name or Email)"
    )
    ...
    start_pay_date = django_filters.DateFilter(
        field_name="pay_date",
        lookup_expr='gt',
        label='Start Pay date',
    )

    end_pay_date = django_filters.DateFilter(
        field_name="pay_date",
        lookup_expr='lt',
        label='End Pay date',
    )
    range_pay_date = django_filters.DateRangeFilter(
        field_name="pay_date",
        label='Range Pay date'
    )
