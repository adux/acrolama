...
ACCOUNT_EMAIL_REQUIRED = int(os.environ.get('ACCOUNT_EMAIL_REQUIRED'))
ACCOUNT_EMAIL_VERIFICATION = int(os.environ.get('ACCOUNT_EMAIL_VERIFICATION'))
ACCOUNT_LOGIN_ATTEMPTS_LIMIT = int(os.environ.get('ACCOUNT_LOGIN_ATTEMPTS_LIMIT'))
ACCOUNT_LOGIN_ON_EMAIL_CONFIRMATION = int(os.environ.get('ACCOUNT_LOGIN_ON_EMAIL_CONFIRMATION'))
ACCOUNT_SESSION_REMEMBER = int(os.environ.get('ACCOUNT_SESSION_REMEMBER'))
ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE = int(os.environ.get('ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE'))
ACCOUNT_SIGNUP_FORM_CLASS = os.environ.get('ACCOUNT_SIGNUP_FORM_CLASS')
ACCOUNT_USERNAME_REQUIRED = int(os.environ.get('ACCOUNT_USERNAME_REQUIRED'))
