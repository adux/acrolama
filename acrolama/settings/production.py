...
ACCOUNT_EMAIL_REQUIRED = int(os.environ.get('ACCOUNT_EMAIL_REQUIRED', default='1'))
ACCOUNT_EMAIL_VERIFICATION = int(os.environ.get('ACCOUNT_EMAIL_VERIFICATION', default='1'))
ACCOUNT_LOGIN_ATTEMPTS_LIMIT = os.environ.get('ACCOUNT_LOGIN_ATTEMPTS_LIMIT')
ACCOUNT_LOGIN_ON_EMAIL_CONFIRMATION = int(os.environ.get('ACCOUNT_LOGIN_ON_EMAIL_CONFIRMATION', default='1'))
ACCOUNT_SESSION_REMEMBER = int(os.environ.get('ACCOUNT_SESSION_REMEMBER', default='1'))
ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE = int(os.environ.get('ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE', default='0'))
ACCOUNT_SIGNUP_FORM_CLASS = os.environ.get('ACCOUNT_SIGNUP_FORM_CLASS')
ACCOUNT_USERNAME_REQUIRED = int(os.environ.get('ACCOUNT_USERNAME_REQUIRED', default='1'))
