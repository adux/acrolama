...
urlpatterns = [
    ...
    #Accounting
    path("herd/accounting/",
        accountinglistview,
        name="accounting_list"
    ),
    path(
        "herd/accounting/<int:pk>/update/",
        InvoiceUpdateView.as_view(),
        name="accounting_update",
    ),

    #Attendance
    path("herd/attendance/",
        attendancelistview,
        name="attendance_list"
    ),
    path(
        "herd/attendance/<int:pk>/update/",
    ...
    path("herd/quotation/",
        ...
        name="quotation_list"),
    path(
        "herd/quotation/<int:pk>/update/",
        QuotationUpdateView.as_view(),
        name="quotation_update",
    ),
    path(
        "herd/quotation/<int:pk>/lock/",
        quotationlockview,
        name="quotation_lock",
    ),
    path(
        "herd/quotation/create/",
        quotationcreateview,
    ...
    #Teachers
    path(
        "herd/teacher/attendance",
        attendance_daily_view,
        name="teacher_attendance",
    ),
    path(
        "herd/teacher/booking/create/",
        BookCreateView.as_view(),
        name="teacher_booking_create",
    ),
